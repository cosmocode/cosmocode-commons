 ...
 * returning true if none of the elements of the iterable apply to the given Rule.
 *
 * @since 1.21
 ...
 */
@Beta
final class NoneOfIterableRule<E> extends AbstractRule<Iterable<E>> {

    private final Rule<E> singleApplicableRule;

    NoneOfIterableRule(@Nonnull final Rule<E> singleApplicableRule) {
