...
/**
 * Tests {@link Strings#EMPTY}.
 *
 * @since 
 * @author Willi Schoenborn
 */
public final class StringsEmptyRuleTest extends AbstractRuleTest<CharSequence> {
    ...
    protected Iterable<CharSequence> invalidInputs() {
        return Lists.<CharSequence>newArrayList("any", "string", "but", "empty", "and", "null");
    }
